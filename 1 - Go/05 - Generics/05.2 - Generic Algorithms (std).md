...
tags: [cmp, constraints, generics, go, maps, slices]
---
...
`slices.SortFunc` dùng trong benchmark tests — liên quan đến [[07.1 - Testing#Benchmarking với `testing.B`]].
