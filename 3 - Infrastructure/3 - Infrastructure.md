...
> VM, Container, Security (Hash, Encrypt, TLS, Password, JWT)

## Mục lục con

| # | Chủ đề | Mô tả |
|---|---------|--------|
| [[3.1 - VM vs Container]] | VM vs Container | Virtualization vs Containerization |
| [[3.2 - Hash vs Encrypt]] | Hash vs Encrypt | One-way vs reversible |
| [[3.3 - Symmetric vs Asymmetric]] | Symmetric vs Asymmetric | Same key vs public/private key |
